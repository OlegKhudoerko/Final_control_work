...
public class ConsoleMenu {
    ...
    private int menuChoicePet(Scanner in) {
        System.out.println("\nВведите номер животного или введите 0 для возврата в основное меню: ");
        while (true) {
            int id = in.nextInt();
            in.nextLine();
            if (id == 0)
            ...
            if (petController.getById(id) == null) {
                System.out.println("Животного с таким номером нет, попробуйте еще раз или введите 0 для возврата в основное меню:");
            } else
                return id;
    ...
    private void menuTrainPet(int petId, Scanner in) {
        Scanner sc = in;
        while (true) {
            System.out.println("Введите новую команду или введите 0 для возврата в основное меню: ");
