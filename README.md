# <p style="text-align: center;">Итоговая контрольная работа</p>   
## <center>Информация о проекте</center>
### <center>Необходимо организовать систему учета для питомника в котором живут домашние и вьючные животные.</center>
